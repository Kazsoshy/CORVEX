...
const userPasswords = [
  ...
  { email: 'roberto.villanueva@corvex.ph',    password: 'OpManager@2026' },
  { email: 'miguel.f@corvex.ph',              password: 'OpManager@2026' },
  { email: 'grace.t@corvex.ph',               password: 'OpManager@2026' },
